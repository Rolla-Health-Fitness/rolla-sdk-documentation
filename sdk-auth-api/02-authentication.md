...
> **Note:** Profile data (name, date of birth, weight, height, gender, timezone) is **not** required at registration. The SDK collects this information through its built-in onboarding flow when the user first opens it — or your app can set it in advance via [Profile & Goals](03-profile.md) so the onboarding is skipped.
...
**Previous:** [Overview](01-overview.md) | **Next:** [Profile & Goals](03-profile.md) | **Home:** [README](README.md)
